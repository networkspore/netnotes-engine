...
import io.netnotes.engine.TokenInfo;
...
public class ErgoWalletsAppBox extends AppBox {
    ...
    public void sendMessage(int code, long timeStamp,String networkId, String msg){
        ...
        if(networkId != null && networkId.equals(NoteConstants.WALLET_NETWORK)){
    ...
    public ErgoWalletsAppBox(Stage appStage, String locationId, NoteInterface ergoNetwork) {
        ...
        m_walletControl = new ErgoWalletControl(locationId, ergoNetwork);
  
        m_lockBox = new LockField(m_walletControl.currentAddressProperty());
        m_appStage = appStage;
        

        ImageView walletIconView = new ImageView(new Image(ErgoConstants.ERGO_WALLETS_ICON));
        ...
        Runnable openWallet = () -> {
            ...
            if (walletFile != null) {
                ...
                m_walletControl.openWalletFile(walletFile, m_networkType);
            }
        };
                    ...
                    for (JsonElement element : walletIds) {
                        if (element != null && element instanceof JsonObject) {
                            ...
                            walletItem.setOnAction(action -> {
                                m_walletControl.setDefaultWallet(id);
                            });
        ...
        m_lockBox.setOnMenuShowing((obs,oldval,newval) -> {
            if(newval){
                ...
                if (m_walletControl.getCurrentAddress() != null) {
                    ...
                    JsonArray jsonArray = m_walletControl.getAddresses();
                    if(jsonArray != null){
    ...
    private class NewWalletBox extends AppBox {
        ...
        public NewWalletBox(boolean isNew) {
            ...
            headingText2.setFont(Stages.txtFont);
            ...
            Runnable createWallet = () -> {
                ...
                if (password.length() > 3 && password.equals(passField2.getText())) {
                    ...
                    saveFileChooser.getExtensionFilters().add(ErgoConstants.ERGO_WALLET_EXT);
                    saveFileChooser.setSelectedExtensionFilter(ErgoConstants.ERGO_WALLET_EXT);
    ...
    private class RemoveWalletBox extends AppBox {
        ...
        private void updateWalletList(){
            JsonArray walletsArray = m_walletControl.getWallets();
        ...
        public RemoveWalletBox() {
            ...
            m_nextBtn.setOnAction(e->{
                if(removeIds.size() == 0){
                    ...
                    m_walletControl.removeWallets(removeIds);
                }
            });
    ...
    private class SendAppBox extends AppBox {
        ...
        public SendAppBox(){
           ...
           // addressFieldBox.setId("bodyBox ");
            ...
            m_feesField = new TextField(NoteConstants.MIN_NETWORK_FEE + "");
            ...
            m_sendBtn.setOnAction(e->{
                ...
                if(!NoteConstants.addFeeAmountToDataObject(feePriceAmount, sendObject)){
                    addSendBox();
        ...
        private void resetSend(){
            m_sendBodyContentBox.getChildren().clear();
            m_feesField.setText(NoteConstants.MIN_NETWORK_FEE + "");
        ...
        public void checkFeeField(){
            ...
            if(Utils.isTextZero(feeString)){
                ...
                if(fee.compareTo(NoteConstants.MIN_NETWORK_FEE) == -1){
                    m_feesField.setText(NoteConstants.MIN_NETWORK_FEE + "");
                }
            }
    ...
    private class WalletSwapBox extends AppBox{
        public static final BigDecimal MIN_SWAP_FEE = NoteConstants.MIN_NETWORK_FEE.multiply(BigDecimal.valueOf(3));
        private final static BigDecimal MIN_ERGO_BALANCE = NoteConstants.MIN_NETWORK_FEE;
        ...
        private final SimpleObjectProperty<PriceQuote> m_priceQuoteInErg = new SimpleObjectProperty<>(null);
 
        private final SimpleObjectProperty<BigDecimal> m_swapFeeProperty = new SimpleObjectProperty<>(MIN_SWAP_FEE);
        private final SimpleObjectProperty<BigDecimal> m_networkFeeProperty = new SimpleObjectProperty<>(NoteConstants.MIN_NETWORK_FEE);
        ...
        private SimpleObjectProperty<TokenInfo> m_tokenInfoProperty = new SimpleObjectProperty<>(null);
        ...
        private ChangeListener<Number> m_tokenMarketQutesUpdateListener = null;
        ...
        public WalletSwapBox(){
            ...
            priceQuoteField.setOnMouseClicked(e->{
                PriceQuote quote = m_priceQuoteInErg.get();         
            ...
            showQuoteInfoBtn.setOnAction(e->{
                if(m_priceQuoteInErg.get() != null && !m_showQuoteInfoProperty.get()){
            ...
            m_ergoMaxBtn.setOnAction(e->{
                ...
                if(ergoBalance != null){
                    BigDecimal maxAmount = ergoBalance.subtract(m_networkFeeProperty.get()).subtract(m_swapFeeProperty.get()).subtract(MIN_ERGO_BALANCE);
            ...
            m_priceQuoteInErg.addListener((obs,oldval,newval)->{
                if(newval != null){
            ...
            m_tokenIdProperty.addListener((obs,oldval,newval)->{
                if(newval != null){
                    ...
                    m_walletControl.getTokenInfo(newval, onSucceeded->{
                        ...
                        if(obj != null && obj instanceof JsonObject){
                            try{
                                TokenInfo tokenInfo = new TokenInfo((JsonObject) obj);
                                m_showTokenInfoProperty.set(false);
                    ...
                    m_priceQuoteInErg.set(null);
                }
                updateBalance();
            });
            updateTokenMarketStatus(m_priceQuoteInErg.get());
            
            m_tokenMarketAvailableListener = (obs,oldval,newval)->updateTokenMarketStatus(m_priceQuoteInErg.get());
            m_walletControl.isTokenMarketAvailable().addListener(m_tokenMarketAvailableListener);
        


            m_tokenMarketQutesUpdateListener = (obs,oldval,newval)->tokenQuotesUpdated();
            m_walletControl.tokenMarketQuotesUpdate().addListener(m_tokenMarketQutesUpdateListener);
        ...
        private void updateQuotes(){
            Utils.delayObject(null, 20, m_walletControl.getNetworksData().getExecService(), onSucceeded->{
                ...
                if(m_isBuyToken.get()){
                    NoteInterface tokenInterface = m_walletControl.getTokenMarketInterface();
                    updateAvailableTokenQuotes(tokenInterface);
                }else{
        ...
        private void updateTxParams(){
            TokenInfo tokenInfo = m_tokenInfoProperty.get();
        ...
        private void tokenQuotesUpdated(){
            PriceQuote currentQuote = m_priceQuoteInErg.get();
            NoteInterface tokenMarketInterface = m_walletControl.getTokenMarketInterface();
            if(m_isBuyToken.get()){
                updateAvailableTokenQuotes(tokenMarketInterface);
            }else{
                updateAvailableSellTokens();
            }
            if(currentQuote != null && tokenMarketInterface != null){
                String tokenId = currentQuote.getBaseId();
                PriceQuote newQuote = m_walletControl.getTokenQuoteInErg(tokenMarketInterface, tokenId);
                m_priceQuoteInErg.set(newQuote);
            }else{
        ...
        private void updateSwapLayout(boolean isBuy){
            ...
            if( m_walletControl.getMarketConnectionStatus()== NoteConstants.STARTED ){
        ...
        private void getPriceQuoteInErg(String tokenId){
            NoteInterface tokenMarketInterface = m_walletControl.getTokenMarketInterface();
            if(tokenMarketInterface != null){
                PriceQuote quote = m_walletControl.getTokenQuoteInErg(tokenMarketInterface, tokenId);
                m_priceQuoteInErg.set(quote);
            }
        }
        ...
        private void updateTokenMarketStatus(PriceQuote quote){
            int status = m_walletControl.getTokenMarketConnectionStatus();
            m_priceQuoteScroll.setText(quote != null ? quote.getSymbol() : status == -1 ? " -Disabled-" : status != NoteConstants.STARTED ? "Loading..." : defaultTokenBtnString);
            
            if(status == NoteConstants.STARTED){
                if(!m_tokenSearchBoxHolder.getChildren().contains(m_tokenSearchBox)){
                    m_tokenSearchBoxHolder.getChildren().add(m_tokenSearchBox);
                }
            }else{
        ...
        public JsonArray getAvailableTokenQuotes(NoteInterface tokenMarketInterface){
            ...
            JsonObject availableQuotesObj = m_walletControl.getAvailableTokenQuotes(tokenMarketInterface, offset, limit, filter);
            ...
            return quotesElement != null && quotesElement.isJsonArray() ? quotesElement.getAsJsonArray() : null;
        }
                

        private void updateAvailableTokenQuotes(NoteInterface tokenInterface){
            boolean hasItems = m_priceQuoteScroll.size() > 0;
            if(tokenInterface != null){
                JsonArray availableQuotes = getAvailableTokenQuotes(tokenInterface);
        ...
        private void addQuoteRow(PriceQuote quote, boolean update){
            ...
            row.setTopRowClicked(e->{
                ...
                m_priceQuoteInErg.set(rowQuote);
        ...
        private void updateTokensFromErgoAmount(BigDecimal ergoAmount, BigDecimal orderPrice, TokenInfo tokenInfo){
            setErgoAmount(ergoAmount);
        ...
        private void updateErgoFromTokenAmount(BigDecimal tokenAmount, BigDecimal orderPrice, TokenInfo tokenInfo){
            setTokenAmount(tokenAmount);
        ...
        @Override
        public void shutdown(){
            if(m_tokenMarketQutesUpdateListener != null){
                m_walletControl.tokenMarketQuotesUpdate().addListener(m_tokenMarketQutesUpdateListener);
            }
            if(m_tokenMarketAvailableListener != null){
                m_walletControl.isTokenMarketAvailable().removeListener(m_tokenMarketAvailableListener);
            }
        }
    }
