    ...
    public class OutputData{
        ...
        public void prepareContract(Wallet wallet) throws Exception{
            ...
            if(isCompileContract()){
                ...
                try {
                    Files.writeString(AppConstants.LOG_FILE.toPath(), "creating helper\n", StandardOpenOption.CREATE, StandardOpenOption.APPEND);
        ...
        public OutBox getOutBox(BlockchainContext ctx, OutBoxBuilder newBoxBuilder){
            try {
                Files.writeString(AppConstants.LOG_FILE.toPath(), "creating contract\n", StandardOpenOption.CREATE, StandardOpenOption.APPEND);
            } catch (IOException e1) {
            ...
            try {
                Files.writeString(AppConstants.LOG_FILE.toPath(), "compiling contract\n", StandardOpenOption.CREATE, StandardOpenOption.APPEND);
            } catch (IOException e1) {
            ...
            if(contract != null){
                try {
                    try {
                        Files.writeString(AppConstants.LOG_FILE.toPath(), "got contract\n", StandardOpenOption.CREATE, StandardOpenOption.APPEND);
                    } catch (IOException e1) {
                ...
                try {
                    Files.writeString(AppConstants.LOG_FILE.toPath(), "built outbox\n", StandardOpenOption.CREATE, StandardOpenOption.APPEND);
                } catch (IOException e1) {
                ...
                try {
                    Files.writeString(AppConstants.LOG_FILE.toPath(), "Creating outBox\n", StandardOpenOption.CREATE, StandardOpenOption.APPEND);
                } catch (IOException e) {
