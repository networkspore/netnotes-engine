...
public class ErgoDexSort {
    ...
    public ErgoDexSort(String type){
        m_type = type;
    }

    public ErgoDexSort(String type, String direction){
        m_type = type;
        m_direction = direction;
    }

    public ErgoDexSort(String type, String direction, String swapTarget){
        m_type = type;
        m_direction = direction;
