...
public class ErgoWalletAmountSendBoxes extends AmountBoxes {
    ...
    public ErgoWalletAmountSendBoxes(Scene scene, NetworkType networktype, ReadOnlyObjectProperty<JsonObject> balanceObject){
        super();
        ...
        balanceObject.addListener(m_balanceChangeListener);
