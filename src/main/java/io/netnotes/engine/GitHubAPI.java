...
public class GitHubAPI {
    ...
    public Future<?> getAssetsLatestRelease(ExecutorService execService, EventHandler<WorkerStateEvent> onFinished, EventHandler<WorkerStateEvent> onFailed){
         return Utils.getUrlJson(getUrlLatestRelease(),execService, (onSucceeded) -> {
                Object sourceObject = onSucceeded.getSource().getValue();
