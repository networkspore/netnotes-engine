...
public final class MouseButtonDownEvent extends RoutedMouseEvent {
    ...
    public MouseButtonDownEvent(ContextPath sourcePath, NoteBytesReadOnly typeBytes, int stateFlags, int button, double x, double y) {
