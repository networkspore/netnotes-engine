...
public class EventBytes {
    ...
    // ===== KEYBOARD EVENTS =====
        ...
        public static final NoteBytesReadOnly EVENT_CONTAINER_CLOSED =
        ...
        register(EVENT_CONTAINER_REGION_CHANGED, "resize", "Container region changed", EventCategory.CONTAINER);
