...
public class PriceQuote {
    ...
    public PriceQuote(String amountString, String baseSymbol, String quoteSymbol) {

        setPrices(amountString, baseSymbol, quoteSymbol);
    }

    public PriceQuote(String amountString, String baseSymbol, String quoteSymbol, long timestamp) {
        m_timestamp = timestamp;
        
        setPrices(amountString, baseSymbol, quoteSymbol);
    }

    public PriceQuote(BigDecimal amount, String baseSymbol, String quoteSymbol,String baseId, String quoteId, long timestamp) {
        m_timestamp = timestamp;
        
        setPrices(amount, baseSymbol, quoteSymbol, baseId, quoteId);
    }
    public PriceQuote(String id, BigDecimal amount, String baseSymbol, String quoteSymbol,String baseId, String quoteId, long timestamp) {
        m_timestamp = timestamp;
        m_id = id;
        setPrices(amount, baseSymbol, quoteSymbol, baseId, quoteId);
    }

    private void setPrices(String amountString, String baseSymbol, String quoteSymbol){
    ...
    public String getAmountString() {
        return m_quoteDecimal.get().toPlainString();
    }
    ...
    public String toString(boolean invert) {
        return invert ? (getInvertedQuote().toPlainString() + " " +  m_quoteSymbol + "/" +m_baseSymbol ) : toString();
    }


    @Override
    public String toString() {
        return getAmountString() + " " + m_baseSymbol + "/" + m_quoteSymbol;
    }
