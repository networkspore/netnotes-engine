...
public final class TerminalHiddenEvent extends TerminalRoutedEvent {
    private final ContextPath sourcePath;
    private int stateFlags;
    private final NoteBytesReadOnly typeBytes;

    public TerminalHiddenEvent(ContextPath sourcePath, NoteBytesReadOnly typeBytes, int flags) {
