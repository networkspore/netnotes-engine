...
public final class TerminalRestoreEvent extends TerminalRoutedEvent {
    private final ContextPath sourcePath;
    private int stateFlags;
    private final NoteBytesReadOnly typeBytes;

    public TerminalRestoreEvent(ContextPath sourcePath, NoteBytesReadOnly typeBytes, int flags) {
