...
public final class TerminalShownEvent extends TerminalRoutedEvent {
    private final ContextPath sourcePath;
    private int stateFlags;
    private final NoteBytesReadOnly typeBytes;

    public TerminalShownEvent(ContextPath sourcePath, NoteBytesReadOnly typeBytes, int flags) {
