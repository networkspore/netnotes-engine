...
public class TerminalFocusLostEvent extends TerminalRoutedEvent {
    private final ContextPath sourcePath;
    private int stateFlags;
    private final NoteBytesReadOnly typeBytes;

    public TerminalFocusLostEvent(ContextPath sourcePath, NoteBytesReadOnly typeBytes, int flags) {
