...
public final class TerminalMinimizeEvent extends TerminalRoutedEvent {
    private final ContextPath sourcePath;
    private int stateFlags;
    private final NoteBytesReadOnly typeBytes;

    public TerminalMinimizeEvent(ContextPath sourcePath, NoteBytesReadOnly typeBytes, int flags) {
