...
public class HardwareInfo extends NoteBytesObject {
    ...
    public static Future<?> getHardwareInfo(NoteStringArray requestList, ExecutorService execService, EventHandler<WorkerStateEvent> onSucceeded, EventHandler<WorkerStateEvent> onFailed){
